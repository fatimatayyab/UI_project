  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        // Example of adjusting layout based on available width
        double itemWidth = constraints.maxWidth > 600 ? constraints.maxWidth * 0.4 : constraints.maxWidth * 0.6;
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    width: itemWidth, // Use adjusted width based on layout
                              ...
                              Row(
                                children: [
                                  const Icon(Icons.emoji_events,
                                      color: Color.fromARGB(255, 205, 169, 10),
                                      size: 18),
